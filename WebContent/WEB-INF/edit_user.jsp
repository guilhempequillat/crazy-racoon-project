		...
		<div class="col-md-6 col-md-offset-3">
			...
			<div class="panel panel-login">
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form id="register-form" action="edit-user" method="POST"
								role="form">
								...
								<div class="form-group">
									<input type="date" value="${user.stringDate}" name="birthdate"
										placeholder="Birthdate" id="birthdate" class="form-control">
								</div>
								<div class="checkbox">
									<label><input id="passwordCheck" type="checkbox"
										name="doChangePassword" value="change"> Change
										Password</label>
									<c:if test="${not empty wrongPassword == true }">
										<c:if test="${ wrongPassword == true }">
											<p style="color: red;">Wrong password
											<p>
										</c:if>
										<c:if test="${ wrongPassword == false }">
											<p style="color: green;">Password Edited
											<p>
										</c:if>
									</c:if>
								</div>
									...
									<div class="row">
										<div class="col-sm-6 col-sm-offset-3">
											<input type="submit" name="register-submit"
												...
												class="form-control btn btn-primary btn-block" value="Edit">
										</div>
									</div>
								</div>
							</form>
